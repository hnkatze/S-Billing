...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Facturacion.Report();
  });
  ...
  describe('Report', function() {
    it('should create an instance of Report', function() {
      ...
      //var instance = new Facturacion.Report();
      //expect(instance).to.be.a(Facturacion.Report);
    });
    ...
    it('should have the property totalBills (base name: "totalBills")', function() {
      // uncomment below and update the code to test the property totalBills
      //var instance = new Facturacion.Report();
      //expect(instance).to.be();
    });
